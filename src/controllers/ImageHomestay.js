...
const { uploadImageRoom, searchRoombyAddress, getroomById, updateRoom, deleteRoom } = require('../repositories/HomeStayImage')
...
module.exports = { uploadFileImage, uploadImage, searchRoom, getAllRoom, getRoomById, updateRoomById, deleteRoomById }